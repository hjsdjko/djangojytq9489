  ...
  <div :style='{"padding":"30px"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='xuesheng'"  label="手机号码" prop="shoujihaoma">
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='jiaoshi'"  label="联系电话" prop="lianxidianhua">
          <el-input v-model="ruleForm.lianxidianhua"               placeholder="联系电话" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='jiaoshi'"  label="班级" prop="banji">
          <el-input v-model="ruleForm.banji"               placeholder="班级" clearable></el-input>
        </el-form-item>
