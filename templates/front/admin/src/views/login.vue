  ...
  <div>
    <div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231128/5a94f436dc0b45ac9c63ac27350c72e9.webp)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":" center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
      <el-form :style='{"padding":"40px 20px 20px","boxShadow":"0 1px 6px rgba(64, 158, 255, .8)","backdrop-filter":"blur(6px)","margin":"0 ","borderRadius":"10px","background":"rgba(255, 255, 255, 0.2)","width":"500px","height":"auto"}'>
        <div v-if="true" :style='{"margin":"0 0 10px 0","color":"#000","textAlign":"center","width":"100%","lineHeight":"44px","fontSize":"20px","fontWeight":"700"}' class="title-container">荣誉证书管理系统设计与实现登录</div>
        ...
        <div :style='{"row-gap":"10px","padding":"0 10%","margin":"20px auto","alignItems":"center","columnGap":"10px","flexWrap":"wrap","display":"flex","width":"100%","justifyContent":"center"}'>
          ...
          <el-button :style='{"border":"1px solid #385d86","cursor":"pointer","padding":"0 24px","margin":"0","outline":"none","color":"#385d86","borderRadius":"4px","background":"transparent","flex":"1","width":"auto","fontSize":"14px","height":"44px"}' type="primary" @click="register('xuesheng')" class="register">注册学生</el-button>
          <el-button :style='{"border":"1px solid #385d86","cursor":"pointer","padding":"0 24px","margin":"0","outline":"none","color":"#385d86","borderRadius":"4px","background":"transparent","flex":"1","width":"auto","fontSize":"14px","height":"44px"}' type="primary" @click="register('jiaoshi')" class="register">注册教师</el-button>
        </div>
      </el-form>
